...
export const handlers = [
    rest.get(`https://api.themoviedb.org/3/movie/now_playing?api_key=1d893d257088d8cf0cf34ce6257955bd&language=en-US&page=1`, (req, res, ctx) => {
        return res(
            ctx.json({results:[{
                id: 1, 
    ...
    rest.get(`https://api.themoviedb.org/3/tv/on_the_air?api_key=1d893d257088d8cf0cf34ce6257955bd&language=en-US&page=1`, (req, res, ctx) => {
        return res(
            ctx.json({results:[{
                id: 3, 
