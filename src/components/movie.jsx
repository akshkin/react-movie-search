    ...
    <>
      ...
      <div className='movie-grid'>
        <div className='movie-content'>
          ...
          <p><span className='bold'>Overview:</span> {overview}</p>
          {
            homepage && 
            <p className='align-baseline'><a href={homepage} target="_blank" rel="noreferrer">Visit homepage </a><LinkIcon className='icon'/></p> 
          } 
          <p className='align-baseline'><span className='bold'>Runtime: </span><ClockIcon className='icon' /> {runtime} minutes</p>
            ...
            <div className='cast-container'>
              {
                ...
                similarMovies.map(similarMovie => 
                  <Card key={similarMovie.id} option="movie" movie={similarMovie} />
                )
              }
            </div>
          </>
