    ...
    <>
      ...
      <div className="movie-grid">
        <div className="movie-content">
          ...
          <p>
            <span className="bold">Number of episodes: </span>{" "}
            {number_of_episodes}
          </p>
          <p>
            <span className="bold">Number of Seasons: </span>{" "}
            {number_of_seasons}
          </p>
        </div>
      ...
      <div className="cast-container">
        {cast?.length ? (
          cast
            .map((char) => <Cast key={char.id} baseImg={baseImg} char={char} />)
          ...
          <div className="cast-container">
            {similarMovies.map((similarMovie) => (
              <Link to={`/tv/${similarMovie.id}`}>
                <Card key={similarMovie.id} option="tv" movie={similarMovie} />
              </Link>
            ))}
          </div>
        </>
